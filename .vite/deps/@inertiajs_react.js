...
var x = (t) => f("navigate", { detail: { page: t } });
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b2 = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
    ...
    let S = typeof e == "string" ? v(e) : e;
    if ((I(n) || l) && !(n instanceof FormData) && (n = A(n)), !(n instanceof FormData)) {
      let [r, s] = k(i, S, n, F2);
      S = v(r), n = s;
    }
    let P = { url: S, method: i, data: n, replace: o, preserveScroll: c, preserveState: h, only: m, headers: b2, errorBag: a, forceFormData: l, queryStringArrayFormat: F2, cancelled: false, completed: false, interrupted: false };
    if (L2(P) === false || !M(P))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let G2 = this.createVisitId();
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L2, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D2, onError: U, queryStringArrayFormat: F2, cancelToken: new AbortController() }, g({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
    } }), W(P), d(P), axios_default({ method: i, url: w(S).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...b2, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...m.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": m.join(",") } : {}, ...a && a.length ? { "X-Inertia-Error-Bag": a } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
      ...
      if (this.isLocationVisitResponse(r.response)) {
        let s = v(r.response.headers["x-inertia-location"]), E2 = S;
  ...
  setPage(e, { visitId: i = this.createVisitId(), replace: n = false, preserveScroll: o = false, preserveState: c = false } = {}) {
    return Promise.resolve(this.resolveComponent(e.component)).then((h) => {
      i === this.visitId && (e.scrollRegions = e.scrollRegions || [], e.rememberedState = e.rememberedState || {}, n = n || v(e.url).href === window.location.href, n ? this.replaceState(e) : this.pushState(e), this.swapComponent({ component: h, page: e, preserveState: c }).then(() => {
        o || this.resetScrollPositions(), n || x(e);
      }));
    });
  }
  pushState(e) {
...
var B = (0, import_react2.createContext)(void 0);
B.displayName = "InertiaHeadContext";
var A2 = B;
var X2 = function({ children: l, title: c }) {
  ...
  function f2(e) {
    let i = import_react.default.Children.toArray(e).filter((r) => r).map((r) => g(r));
...
var $2 = (0, import_react3.forwardRef)(({ children: l, as: c = "a", data: s = {}, href: p, method: a = "get", preserveScroll: S = false, preserveState: d = null, replace: P = false, only: u2 = [], headers: g = {}, queryStringArrayFormat: f2 = "brackets", onClick: e = F, onCancelToken: i = F, onBefore: r = F, onStart: y = F, onProgress: T = F, onFinish: H2 = F, onCancel: h = F, onSuccess: M2 = F, onError: x2 = F, ...O2 }, R2) => {
  let I2 = (0, import_react3.useCallback)((o) => {
    e(o), ee(o) && (o.preventDefault(), Oe.visit(p, { data: s, method: a, preserveScroll: S, preserveState: d ?? a !== "get", replace: P, only: u2, headers: g, onCancelToken: i, onBefore: r, onStart: y, onProgress: T, onFinish: H2, onCancel: h, onSuccess: M2, onError: x2 }));
  }, [s, p, a, S, d, P, u2, g, e, i, r, y, T, H2, h, M2, x2]);
...
<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react3.createElement)(c, { ...O2, ...c === "a" ? { href: p } : {}, ref: R2, onClick: I2 }, l);
});
$2.displayName = "InertiaLink";
var ae2 = $2;
var j2 = (0, import_react6.createContext)(void 0);
j2.displayName = "InertiaPageContext";
var E = j2;
function w2({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S }) {
  let [d, P] = (0, import_react5.useState)({ component: s || null, page: c, key: null }), u2 = (0, import_react5.useMemo)(() => Q(typeof window > "u", a || ((f2) => f2), S || (() => {
  })), []);
  if ((0, import_react5.useEffect)(() => {
    ...
    return (0, import_react5.createElement)(A2.Provider, { value: u2 }, (0, import_react5.createElement)(E.Provider, { value: d.page }, null));
  let g = l || (({ Component: f2, props: e, key: i }) => {
    let r = (0, import_react5.createElement)(f2, { key: i, ...e });
    return typeof f2.layout == "function" ? f2.layout(r) : Array.isArray(f2.layout) ? f2.layout.concat(r).reverse().reduce((y, T) => (0, import_react5.createElement)(T, { children: y, ...e })) : r;
  });
  return (0, import_react5.createElement)(A2.Provider, { value: u2 }, (0, import_react5.createElement)(E.Provider, { value: d.page }, g({ Component: d.component, key: d.key, props: d.page.props })));
}
w2.displayName = "Inertia";
async function V({ id: l = "app", resolve: c, setup: s, title: p, progress: a = {}, page: S, render: d }) {
  let P = typeof window > "u", u2 = P ? null : document.getElementById(l), g = S || JSON.parse(u2.dataset.page), f2 = (r) => Promise.resolve(c(r)).then((y) => y.default || y), e = [], i = await f2(g.component).then((r) => s({ el: u2, App: w2, props: { initialPage: g, initialComponent: r, resolveComponent: f2, titleCallback: p, onHeadUpdate: P ? (y) => e = y : null } }));
  if (!P && a && Z(a), P) {
    let r = await d((0, import_react4.createElement)("div", { id: l, "data-page": JSON.stringify(g) }, i));
...
function W2(l, c) {
  ...
  let v2 = (0, import_react7.useCallback)((t, o, n = {}) => {
    let k2 = { ...n, onCancelToken: (m) => {
      ...
      if (x2(false), R2(false), clearTimeout(P.current), n.onBefore)
        return n.onBefore(m);
    }, onStart: (m) => {
      if (T(true), n.onStart)
        return n.onStart(m);
      ...
      if (s.current && (T(false), h(null), e({}), r(false), x2(true), R2(true), P.current = setTimeout(() => {
        s.current && R2(false);
      }, 2e3)), n.onSuccess)
  ...
  return { data: u2, setData(t, o) {
    ...
    S(typeof t > "u" ? () => u2 : (n) => ({ ...n, ...typeof t == "string" ? { [t]: o } : t }));
  }, reset(...t) {
