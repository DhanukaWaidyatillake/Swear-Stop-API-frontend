        ...
        <Card className="h-full w-full mt-20">
            <CardHeader floated={false} shadow={false} className="rounded-none">
                <div className="flex items-center justify-between gap-8">
                    ...
                    <div className="flex shrink-0 flex-col gap-2 sm:flex-row mr-2">
                        <Button className="flex items-center gap-3 bg-white text-black border-black border-2" size="sm">
                            <PlusIcon strokeWidth={2} className="h-4 w-4"/> Add Whitelisted Word
                        </Button>
                    </div>
                </div>
            </CardHeader>
                        ...
                        ({name, added_on, online, date,enabled}, index) => {
                            ...
                            return (
                                <tr key={name}>
                                    ...
                                    <td className={classes}>
                                        <Switch
                                            id={`whitelist-switch-component-${index}`}
                                            ripple={true}
