...
export default function ManageListPopup({list_type, visible, setVisible, newBannedWordAdded}) {
    ...
    function submit(e) {
        ...
        form.post(list_type === "blacklist" ? '/add_word_to_blacklist' : '/add_word_to_whitelist', {
            ...
            onError: (error) => {
                const errorMessage = error.word || 'Something went wrong';
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="flex flex-col gap-4 p-6">
                        <h4
                            ...
                            Add Word To {list_type.charAt(0).toUpperCase() + list_type.slice(1)}
                        </h4>
                        <div className="relative h-11 w-full min-w-[200px]">

                            <input type="text" value={form.data.word}
