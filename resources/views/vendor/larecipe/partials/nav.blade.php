<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        <div class="flex items-center flex-no-shrink">
            <a href="{{ url('/') }}" class="text-black mx-4 w-10">
                @include("larecipe::partials.logo")
            </a>

            <p class="inline-block font-semibold mx-1 text-grey-dark w-3/4">
                {{ config('app.name') }}
            </p>
            {{--            </a>--}}

            <div class="switch sm:hidden">
...
{{--            <larecipe-button tag="a" href="https://github.com/saleem-hadad/larecipe" target="__blank" type="black"--}}
{{--                             class="mx-2 px-4">--}}
